(defproject alert-viewer "0.1.0-SNAPSHOT"
  ...
  :profiles {:dev {:source-paths ["env/dev/clj"]
                   ...
                   :repl-options {:init-ns alert-viewer.server
                   ...
                   :figwheel {:http-server-root "public"
                              ...
                              :ring-handler alert-viewer.server/http-handler}
